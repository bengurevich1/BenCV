        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="modal-title">music palyer</h4>
                    <p>Dive into my meticulously crafted playlist web portfolio. Here you'll encounter a blend of
                        responsive design, interactive features, and captivating multimedia. Experience unique playlists
                        and intuitive navigation through this love letter to music. Discover now!</p>
                </div>
                <div class="modal-footer">
                    <a href="http://se.shenkar.ac.il/students/2022-2023/web1/dev_25/exercises/ex1/index.html"
    ...
    <div id="portfolioItem2" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="modal-title">personal portfolio</h4>
                    <p>Unveil a meticulously crafted profile page, displaying the culmination of precision, creativity,
                        and efficiency. Each segment, governed by meaningful tags, echoes the commitment to cleanliness,
                        minimality, and accuracy in code. Explore an array of exercises demonstrating diverse skills,
                        intertwined with enticing visuals and user-friendly navigation. Dive into the realm of
                        programming languages and enjoy a customized area showcasing unique coding exploits. Every
                        detail, every pixel, has been shaped with precision. </p>
                </div>
                <div class="modal-footer">
                    <a href="http://se.shenkar.ac.il/students/2022-2023/web1/dev_25/index.html"
                        class="btn btn-fill">Visit Page</a>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    ...
    <div id="portfolioItem3" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="modal-title">Dynamic squares</h4>
                    <p>Experience the perfect fusion of structure and creativity. Check out my portfolio - a visual
                        treat built with intricate HTML and CSS, featuring multiple unique layouts. Also, there's a
                        twist - the dynamic element is powered by a sophisticated JavaScript code. This portfolio is a
                        testament to my coding proficiency and design aesthetics. Curious? Dive into the code right
                        away!</p>
                </div>
                <div class="modal-footer">
                    <a href="http://se.shenkar.ac.il/students/2022-2023/web1/dev_25/exercises/ex3/index.html"
                        class="btn btn-fill">Visit Page</a>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Uncover the sophisticated blend of HTML, CSS, JavaScript, and PHP in my latest work - an
                        interactive, user-friendly membership form. Compliant with modern web standards, it validates
                        user inputs in real-time, creating a seamless user experience. Not only does it look great, but
                        it functions brilliantly too. Venture in and explore the efficient, effective, and elegant
                        coding behind this web form masterpiece.</p>
                </div>
                <div class="modal-footer">
                    <a href="http://se.shenkar.ac.il/students/2022-2023/web1/dev_25/exercises/ex4/index.html"
                        class="btn btn-fill">Visit Page</a>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    ...
    <div id="portfolioItem5" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="modal-title">book store</h4>
                    <p>Explore my detailed portfolio, featuring a robust online bookstore application. Tasked with
                        creating a user-friendly HTML layout with Bootstrap, it seamlessly integrates with JavaScript
                        and PHP for dynamic content. Diving into back-end, it utilizes JSON for data handling and SQL
                        for database interactions. Experience how my code simplifies e-commerce with a click on the
                        link!</p>
                </div>
                <div class="modal-footer">
                    <a href="http://se.shenkar.ac.il/students/2022-2023/web1/dev_25/exercises/ex5/product_list.php"
                        class="btn btn-fill">Visit Page</a>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
